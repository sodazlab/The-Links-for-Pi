...
const BentoGrid: React.FC<BentoGridProps> = ({ posts }) => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 md:h-[480px]">
        {/* Main Hero Card - Takes up 2x2 space on desktop */}
        {primary && (
          <div className="col-span-1 md:col-span-2 md:row-span-2 min-h-[300px] md:h-full">
        ...
        {/* Smaller Cards */}
        {secondary.map((post) => (
          <div key={post.id} className="col-span-1 md:col-span-1 md:row-span-1 min-h-[180px] md:h-full">
